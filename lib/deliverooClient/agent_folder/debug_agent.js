...
socket.on("connect", async function(){
    ...
    console.log('Ok, running the simulation...');
...
async function ARE_YOU_WINNING_SON(){
    ...
    while(true){
        ...
        */
        scores += plan.pathScore;
        console.log('Path completed with score ' + plan.pathScore + ' current mean score: ' + scores/iter);
        iter += 1;
